        ...
        NavigationStack {
            List {
                Section {
                    ...
                    Text("The TV stream runs a few seconds behind (HLS) — great for watching, not for control. AirPlay is built in; Google Cast and Matter Casting appear here when their SDKs are added to the app (ADR 0011).")
                }
