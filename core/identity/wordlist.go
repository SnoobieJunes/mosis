...
// Wordlist is the FROZEN 256-word pairing fingerprint list, byte-identical to
// the Swift PairingWordlist. Its SHA-256 is pinned in proto/vectors/pairing.json;
// a conformance test fails on any drift (docs/adr/0004).
var Wordlist = []string{
